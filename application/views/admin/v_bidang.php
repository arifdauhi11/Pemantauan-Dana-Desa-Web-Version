<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-archive"></i> Bidang</li>
      </ol>
    </section>
      ...
      <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-header with-border">
              <button type="button" class="btn btn-primary" data-toggle="modal" onclick="addBidang()">
              Tambah Bidang
              </button>
            ...
            <div class="box-body" style="">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>                                      
                    ...
                    <?php if ($this->session->userdata('role_id') == '8') { ?>
                    <td>
                      <button class="btn btn-sm btn-warning" onclick="editBidang(<?php echo $b->id_bidang ;?>)"><i class="fa fa-edit"></i> Edit</button>
                      <button class="btn btn-sm btn-danger" onclick="deleteBidang(<?php echo $b->id_bidang ;?>)"><i class="fa fa-trash"></i> Hapus</button>
                    </td>
                    <?php } ?>
                    </tr>
                    <?php } ?>                    
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary pull-right" onclick="saveBidang()">Submit</button>
            </div>
          </div>
        </div>
      </div>    
